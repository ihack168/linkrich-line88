...
export default function PublicLandlordPage() {
  ...
  return (
    <div className="bg-background text-foreground">
      <section className="mx-auto max-w-5xl px-6 pt-12 text-center md:pt-16">
      ...
      <section className="mx-auto mb-24 mt-20 max-w-4xl px-6 text-center">
        ...
        <LineConsultButton className="mt-8 inline-flex rounded-full bg-[#06C755] px-8 py-4 text-sm font-semibold text-white shadow-[0_14px_36px_rgba(31,78,121,0.28)]">
          加入 LINE 免費諮詢
        </LineConsultButton>
      </section>
    </div>
